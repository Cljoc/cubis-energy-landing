const steps = [
  { n: '۰۱', title: 'اتصال منابع داده', desc: 'اتصال سنسورها، کنتورها، فایل‌های Excel/CSV و سامانه‌های CMMS و DCS به CUBIS.' },
    ...
    <section id="how" className="py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="relative mt-16 grid gap-8 md:grid-cols-4">
          <div className="pointer-events-none absolute top-6 hidden h-px w-full bg-gradient-to-l from-transparent via-white/15 to-transparent md:block" />
          {steps.map((s, i) => (
