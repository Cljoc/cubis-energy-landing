    ...
    <section className="relative overflow-hidden border-y border-white/5 bg-navy-2/40 py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2 lg:px-10">
        <Reveal className="order-2 lg:order-1">
          <div className="relative mx-auto max-w-md rotate-1 overflow-hidden rounded-2xl border border-white/10 shadow-2xl shadow-black/50 transition duration-500 hover:rotate-0 hover:scale-[1.02]">
        ...
        <div className="order-1 lg:order-2">
          <Reveal>
            ...
            <p className="mt-5 max-w-lg leading-8 text-mist">
              پلتفرم مدیریت هوشمند انرژی به‌جای انبوهی از نمودار خام، داده‌های کارخانه را تحلیل می‌کند و مشاهدات و
